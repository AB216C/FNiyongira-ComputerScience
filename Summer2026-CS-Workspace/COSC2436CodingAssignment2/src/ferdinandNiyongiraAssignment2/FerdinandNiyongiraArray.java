...
public class FerdinandNiyongiraArray {
	
	public static void ferdinandNiyongiraPrint(int[] list) 
	{
		System.out.print("[");	//Print an an opening bracket
	...
	public static void ferdinandNiyongiraInsertionSort(int[] list) 
	{
	...
	public static void ferdinandNiyongiraBubbleSort(int[] list) 
	{
	...
	public static void ferdinandNiyongiraMergeSort(int[] list) 
	{
		...
		if (list.length>1) 
		{
			...
			ferdinandNiyongiraMergeSort(firstHalf);
			...
			ferdinandNiyongiraMergeSort(secondHalf);
			
			//Merge first half and second half into a list
			ferdinandNiyongiraMerge(firstHalf, secondHalf, list);
		}
		
	}
	
	/*Create a method to merge two sorted halves*/
	public static void ferdinandNiyongiraMerge(int[] list1, int[] list2, int[] temp) 
	{
	...
	public static void ferdinandNiyongiraQuickSort(int[] list) 
	{
		ferdinandNiyongiraQuickSort(list, 0, list.length-1);
	}
	
	/*Recursively sort a portion of the array*/
	public static void ferdinandNiyongiraQuickSort(int[] list, int first, int last) 
	{
		//Continue if there is more than one element
		if(last > first) 
		{
			//Partition the array and get the pivot's final position
			int pivotIndex = ferdinandNiyongiraPartition(list, first, last);
			
			//Sort the left side of the pivot
			
			ferdinandNiyongiraQuickSort(list, first, pivotIndex-1);
			
			//Sort the right side of the pivot
			ferdinandNiyongiraQuickSort(list, pivotIndex+1, last);
	...
	public static int ferdinandNiyongiraPartition(int[] list, int first, int last) 
	{
	...
	// And show which sorting method is better with explanations
