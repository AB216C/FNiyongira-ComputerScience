...
public class RelatableExamDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println("Exam1: " + exam2.getScore());
		...
		{
			System.out.println("Both exam score are equal");
		}
		
		if(exam1.isGreater(exam2)) 
		{
			System.out.println("Exam1  score is the highest");
		}
		
		if(exam1.isLess(exam2)) 
		{
			System.out.println("Exam1 score is the lowest");
		}
