...
/*
 * This class hold data for a computer science student
 * */

public class CompSciStudent extends Student {
	
	//Constants for the math, computer science, and general education hours required for graduation
	...
	private int mathHours,			//Math hours taken
				...
				genEdHours;			//General Education hours taken
	...
	public CompSciStudent(String n, String id, int years) 
	{
		super(n, id, years);
	...
	public String toString() 
	{
		...
		//Create a string representing this computer science student's hours taken
	...
	public int getRemainingHours()
	{
		...
		//Calculate the the remaining hours
