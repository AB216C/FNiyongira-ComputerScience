...
/*The Telephone class provides static methods for formating and unformating US Telephone number*/
...
public class Telephone {
	...
	public final static int UNFORMATTED_LENGTH = 10;
	  ...
	  and determines whether it is properly formatted as  a US telephone number in the following manner:
	  (XXX)XXX–XXXX
	...
	{
		boolean valid; 			//Flag to indicate 
		...
		//Return the value of valid flag
	...
	{
		//Create a StrinbBuilder and Initialize it with str
	...
	public static String format(String str)
	{
		...
		if(str.length() == UNFORMATTED_LENGTH)
		{
			...
			// Next insert the right parent at position 4.
			strb.insert(4, ')');
			
			//Next, insert hyphen at position 8
