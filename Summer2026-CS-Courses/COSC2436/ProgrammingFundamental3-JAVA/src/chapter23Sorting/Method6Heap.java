...
public class Method6Heap<E> {

    // Stores the heap elements
    ...
    public Method6Heap(java.util.Comparator<E> c)
    {
        this.c = c;
    }

    /** Create a heap from an array of objects */
    public Method6Heap(E[] objects)
    {
        this.c = (e1, e2) -> ((Comparable<E>) e1).compareTo(e2);

        // Add every object into the heap
    ...
    public void add(E newObject)
    {
        ...
        // Move upward until the heap property is restored
